          ...
          <?php $blog_info = get_bloginfo( 'name' ); ?>
            <?php if ( ! empty( $blog_info ) ) : ?>
              <?php if ( is_front_page() && is_home() ) : ?>
                <?php if( get_theme_mod('vw_storefront_logo_title_hide_show',true) == 1){ ?>
            ...
            ?>
            <?php if( get_theme_mod('vw_storefront_tagline_hide_show',false) == 1){ ?>
          ...
          <div class="phone_no">
            <div class="row">
              ...
              <div class="col-lg-10 col-md-10 col-10">
                ...
                <strong><a href="tel:<?php echo esc_attr( get_theme_mod('vw_storefront_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('vw_storefront_phone_number',''));?></a></strong>
              </div>
            </div>
          </div>
        <?php } ?>
